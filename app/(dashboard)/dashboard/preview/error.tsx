// Error boundary for the preview route segment
'use client'
...
export default function PreviewError({ error, reset }: Props) {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 flex items-center justify-center min-h-64">
      <div className="bg-white rounded-xl border border-red-200 p-8 max-w-md w-full text-center space-y-4">
        <h2 className="text-lg font-semibold text-gray-900">Could not load preview</h2>

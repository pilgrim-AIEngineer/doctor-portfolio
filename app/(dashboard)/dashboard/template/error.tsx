// Error boundary for the template picker route segment
'use client'
...
export default function TemplateError({ error, reset }: Props) {
  useEffect(() => {
    console.error('[TemplateError]', error)
  }, [error])
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 flex items-center justify-center min-h-64">
      <div className="bg-white rounded-xl border border-red-200 p-8 max-w-md w-full text-center space-y-4">
        <h2 className="text-lg font-semibold text-gray-900">Could not load templates</h2>
